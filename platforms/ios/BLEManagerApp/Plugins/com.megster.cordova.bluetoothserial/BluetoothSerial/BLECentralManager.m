...
- (void)startScan {
    ...
    NSLog(@"[BTLECentral] scan started ----------");
...
- (void)stopScan {
    ...
    NSLog(@"[BTLECentral] stop scanning ----------");
...
- (void)centralManager:(CBCentralManager *)central didDiscoverPeripheral:(CBPeripheral *)peripheral advertisementData:(NSDictionary *)advertisementData RSSI:(NSNumber *)RSSI {
    ...
    if (peripheral.identifier == NULL) {
        NSLog(@"--- ERROR --- [BTLECentral] didDiscoverPeripheral unknown");
        return;
    }
    
    NSLog(@"[BTLECentral] didDiscoverPeripheral -- %@ (%ld)", peripheral.name, (long)RSSI.integerValue);
